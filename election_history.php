                ...
                <div class="nano-content">
                    ...
                    <div class="logo"><img src="assets/res/images/logo.png" alt="" /> <span><br>Online Voting System</br></span></div>
                      ...
                      <li><a href="election_decleration.php"><i class="ti-exchange-vertical"> </i><span>Election Declaration </span> </a></li>
                        ...
                        <li><a href="result_page.php"><i  class="ti-ticket"> </i> Result  </a></li>
                        <li class="active"><a href="#"><i  class="ti-time"> </i>Election History  </a></li>
            ...
            <tbody>
                <?php while ($candidate = $candidates->fetch_assoc()): ?>
                    ...
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($candidate['election_starting_date']); ?></td>
                        <td style="text-align:center;"><?php echo htmlspecialchars($candidate['election_ending_time']); ?></td>
                    </tr>
                <?php endwhile; ?>
