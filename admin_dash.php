                ...
                <div class="nano-content">
                   <ul>
                    <div class="logo"><img src="assets/res/images/logo.png" alt="" /> <span><br>Online Voting System</br></span></div>
                        ...
                        <li class="active"><a class="sidebar-sub-toggle"> <i class="ti-user"> </i>Admin's Dashboard <span class="badge badge-primary"></span> </a>
...
echo "<h5>Available Elections</h5>";
                       ...
                       ?>
<form method="post" action="vote_admin.php">
