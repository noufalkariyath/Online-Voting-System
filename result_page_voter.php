                ...
                <div class="nano-content">
                    ...
                    <div class="logo"><img src="assets/res/images/logo.png" alt="" /> <span><br>Online Voting System</br></span></div>
                      ...
                      <li><a href="voter_dash.php"><i  class="ti-user"> </i> Voter's dashboard </a></li>
                        ...
                        <li><a href="upcoming_elections_voter.php"><i class="ti-exchange-vertical"> </i><span>Upcoming Elections </span> </a></li>
                        <li class="active"><a href="#"><i  class="ti-ticket"> </i> Result  </a></li>
...
?>
<form method="post" action="result_voter.php">
