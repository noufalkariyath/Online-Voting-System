...
echo "<h5>Available Elections</h5>";
                       $candidates = $conn->query("SELECT * FROM election_declaration WHERE candidate_registration_starting_date < '$currentDateTime' AND candidate_registration_ending_date > '$currentDateTime'");
                       ?>
<form method="get" action="candidate_approval.php">
